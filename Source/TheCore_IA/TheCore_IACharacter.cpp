...
ATheCore_IACharacter::ATheCore_IACharacter()
{
...
void ATheCore_IACharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATheCore_IACharacter::Move);
...
void ATheCore_IACharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATheCore_IACharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
